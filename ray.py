...
if __name__ == "__main__":
	...
	s2 = Sphere([4, 2, 1], 0.5, Material(Color(0, 250, 0), 0.5, 0.8, 0.2))
	s3 = Sphere([-3, 2, 1], 1, Material(Color(0, 0, 250), 0.5, 0.8, 0.2))
	s4 = Sphere([2, -2, 1], 0.8, Material(Color(0, 250, 250), 0.5, 0.8, 0.2))
